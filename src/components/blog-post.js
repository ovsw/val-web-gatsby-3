  ...
  return (
    <>
      ...
      <div className="in-blog-metatop">
        <span>
          {" "}
          Published on: {format(publishedAt, "MMMM Do, YYYY")} | Written by Jimmy Vercellino
        </span>
      </div>
      <img
      ...
      <div className="admin-author-details pt-5">
        ...
        <div className="admin-aouthor">
          <div className="admin-image">
            <img
              src="/images/blog/author-image/author-image-1.png"
              alt="VA loan specialist Jimmy Vercellino"
            />
          </div>
          <div className="admin-info">
            ...
            <p>
              Jimmy Vercellino, a Marine veteran, specializes in helping military veterans benefit
              from the VA Loan Program and buy the home of their dreams.
            </p>
